 ...
 * @version 1.0
 */
public class AffineTransformationsComponent extends JComponent implements ResetableRectangle {
	 ...
	 */
	public AffineTransformationsComponent(ObservableFlameBuilder builder, Rectangle rectangle) {
	 ...
	 */
	private void drawGrid(Graphics2D g2d, AffineTransformation convert, Rectangle tmp) {
	 ...
	 */
	private void drawTransformation(Graphics2D g2d, AffineTransformation convert, AffineTransformation transformation) {
	 ...
	 */
	private void drawLine(Graphics2D g2d, AffineTransformation convert, Point p1, Point p2) {
		// The points are converted to the coordinate system of the graphics object 
		p1 = convert.transformPoint(p1);
		p2 = convert.transformPoint(p2);
