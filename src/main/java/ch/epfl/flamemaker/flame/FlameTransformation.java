...
public final class FlameTransformation implements Transformation {
    ...
    public static final class Builder {
         ...
         */
        public Builder(final FlameTransformation transformation) {
         ...
         */
        public void setAffineTransformation(final AffineTransformation transformation) {
         ...
         */
        public double variationWeight(final Variation variation) {
         ...
         */
        public void setVariationWeight(final Variation variation, final double weight) {
