...
public final class Color {
	 ...
	 */
	public Color mixWidth(Color color, double proportion) {
	...
	public int asPackedRGB() {
		...
		return ((int) sRGBEncode(red(), 255) << 16)
				+ ((int) sRGBEncode(green(), 255) << 8)
				+ (int) sRGBEncode(blue(), 255);
	}
	 ...
	 */
	public static double colorIndex(int n) {
		if (n == 0) return 0;
		if (n == 1) return 1;
